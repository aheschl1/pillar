...
mod tests {
    ...
    use crate::{
        crypto::{
            hashing::{DefaultHash, HashFunction, Hashable},
            signing::{DefaultSigner, SigFunction, SigVerFunction, Signable},
        },
        nodes::{
            messages::Message,
            miner::{Miner, MAX_TRANSACTION_WAIT_TIME},
            node::{NodeState, StdByteArray},
            peer::Peer,
        },
